...
export function ManualSimulacroQuestionEditor({ 
  ...
  const areaNumberMaps = buildQuestionAreaNumberMaps(
    sortedQuestions.map((q) => ({
      id: q.id,
      areaKey: q.competencyId || 'general',
      areaLabel: getAreaDisplayName(q.competencyId || ''),
    }))
  )
  ...
  return (
    <div className="space-y-4">
      ...
      <FormDialog
        ...
        description="Primero escribe el enunciado (texto base del ICFES) y luego la pregunta específica de opción múltiple. Los metadatos (tema, subtema, componente) son requeridos."
      >
