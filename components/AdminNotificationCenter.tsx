...
function NotificationItem({ notification, onMarkAsRead, onDelete }: NotificationItemProps) {
  ...
  const typeLabel = notificationTypeLabels[notification.type as keyof typeof notificationTypeLabels] || notification.type;
  const typeColor = notificationTypeColors[notification.type as keyof typeof notificationTypeColors] || 'bg-gray-100 text-gray-800';
